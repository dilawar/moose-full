...
APP_NAME="Moose"
VERSION="3.0.2"
DMG_BACKGROUND_IMG="./moose_icon_64x64.png"
...
# NOTE: Using --relative -R option of rsync
rsync -azv --ignore-existing --delete --exclude=.git -R /usr/local/ "${STAGING_DIR}"
...
SIZE=`du -sh "${STAGING_DIR}" | cut -f1 | sed 's/[^0-9\.]*//g'`
